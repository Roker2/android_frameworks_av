...
{
    ALOGI("status_t BnAudioFlinger::onTransact, code");
    switch (code) {
        case CREATE_TRACK: {
            ALOGI("CREATE_TRACK");
        ...
        case SET_MASTER_VOLUME: {
            ALOGI("SET_MASTER_VOLUME");
            CHECK_INTERFACE(IAudioFlinger, data, reply);
            reply->writeInt32( setMasterVolume(data.readFloat()) );
            return NO_ERROR;
        } break;
        case SET_MASTER_MUTE: {
            ALOGI("SET_MASTER_MUTE");
            CHECK_INTERFACE(IAudioFlinger, data, reply);
        ...
        case NEW_AUDIO_SESSION_ID: {
            ALOGI("NEW_AUDIO_SESSION_ID");
            CHECK_INTERFACE(IAudioFlinger, data, reply);
            reply->writeInt32(newAudioUniqueId());
            return NO_ERROR;
        } break;
        case ACQUIRE_AUDIO_SESSION_ID: {
            ALOGI("ACQUIRE_AUDIO_SESSION_ID");
            CHECK_INTERFACE(IAudioFlinger, data, reply);
        ...
        case RELEASE_AUDIO_SESSION_ID: {
            ALOGI("RELEASE_AUDIO_SESSION_ID");
            CHECK_INTERFACE(IAudioFlinger, data, reply);
            int audioSession = data.readInt32();
            int pid = data.readInt32();
