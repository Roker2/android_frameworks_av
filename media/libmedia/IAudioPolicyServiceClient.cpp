...
{
    ALOGI("status_t BnAudioPolicyServiceClient::onTransact, code");
    switch (code) {
    case PORT_LIST_UPDATE: {
            ALOGI("PORT_LIST_UPDATE");
            CHECK_INTERFACE(IAudioPolicyServiceClient, data, reply);
            onAudioPortListUpdate();
            return NO_ERROR;
        } break;
    case PATCH_LIST_UPDATE: {
            ALOGI("PATCH_LIST_UPDATE");
            CHECK_INTERFACE(IAudioPolicyServiceClient, data, reply);
            onAudioPatchListUpdate();
            return NO_ERROR;
        } break;
    case MIX_STATE_UPDATE: {
            ALOGI("MIX_STATE_UPDATE");
            CHECK_INTERFACE(IAudioPolicyServiceClient, data, reply);
    ...
    case OUTPUT_SESSION_EFFECTS_UPDATE: {
            ALOGI("OUTPUT_SESSION_EFFECTS_UPDATE");
            CHECK_INTERFACE(IAudioPolicyServiceClient, data, reply);
